...
namespace EventEaseAppOwethuHadebeMVC.Controllers
{
    public class EventController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? searchType, int? venueID, DateTime? startDate, DateTime? endDate)
        {
            ...
            if (searchType.HasValue)
                events = events.Where(e => e.EventTypeID == searchType.Value);
